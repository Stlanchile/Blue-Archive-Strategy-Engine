...
aggregation, API, dependency, and reproducibility surfaces. It is outside the
v0.2 scope and Rayon is intentionally absent.

## Decision

Keep serial Monte Carlo. Do not add `--jobs`, worker scheduling, parallel
aggregation, or a Rayon dependency in v0.2.
